...
<div class="dashboardProperties">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">FAQ Request</li>
    </ol>
    ...
    <div class="table_header">
        ...
        <div class="right">
            <ul>
                <li>
                    <a href="{{ route('dashboardfaqrequest') }}">Reload</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <tr role="row" class="{{$trClass}}">
                    ...
                    <td>
                        <div class="table-actions">
                            <a action-delete="{{ URL::to('/dashboard/faq-request/delete/'.$datas->id) }}" class="btn btn-icon btn-sm btn-danger deleteDialog deleteQueryOperation">
