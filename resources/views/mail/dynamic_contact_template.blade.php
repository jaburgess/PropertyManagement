                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;text-align: left;">
                                    <h1 style="color:#1e1e2d;font-weight: 500;margin: 0px 0px 10px;font-size: 30px;">Contact Request</h1>
                                    <p style="color:#455056;font-size:15px;line-height:24px;margin:0;padding:20px 0px">
                                        <label style="display: block;">
                                            <b style="display: inline-block;width: 70px;text-align: left;display: inline-block;">Name:</b> {{$dataEmail['name']}}<br>
                                            <b style="display: inline-block;width: 70px;text-align: left;display: inline-block;">Email:</b> {{$dataEmail['email']}}<br>
                                            <b style="display: inline-block;width: 70px;text-align: left;display: inline-block;">Subject:</b> {{$dataEmail['subject']}}<br>
                                            <b style="display: inline-block;width: 70px;text-align: left;display: inline-block;">Message:</b> {{$dataEmail['message']}}</label>
                                            <b style="display: inline-block;width: 70px;text-align: left;display: inline-block;">Contact:</b> {{$dataEmail['cont_type']}}</label>
                                    </p>
                                </td>
                            </tr>
                            <tr>
