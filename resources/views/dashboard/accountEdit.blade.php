...
<div class="propertyCreate dashboardProperties">
    ...
    <form method="POST" class="faq formvalidationappeared accountCreateForm" action="{{ route('dashboardAccountEditPost') }}" id="botble-real-estate-forms-property-form" enctype="multipart/form-data" >
        @csrf
            ...
            <div class="col-md-9">
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group mb-3 title_div editAccount user_account_id_div">
                            <label for="userid" class="control-label" aria-required="true">ID Type</label>
                            <input class="form-control" placeholder="ID Type" name="userid" type="text" value="{{$account->userid}}" id="userid" />
                        </div>
                        <div class="form-group mb-3 title_div editAccount user_account_id_div">
                            <label for="userid" class="control-label" aria-required="true">ID Number</label>
                            <input class="form-control" placeholder="ID Number" name="useridnumber" type="number" value="{{$account->useridnumber}}" id="useridnumber" />
                        </div>
                        <div class="form-group mb-3 title_div editAccount user_account_id_div">
                            ...
                            <select class="control-label" name="useridyear" id="useridyear">
                                <option @if($account->useridyear=='2023') selected @endif value="2023">2023</option>
                                <option @if($account->useridyear=='2024') selected @endif value="2024">2024</option>
                                <option @if($account->useridyear=='2025') selected @endif value="2025">2025</option>
                                <option @if($account->useridyear=='2026') selected @endif value="2026">2026</option>
                                <option @if($account->useridyear=='2027') selected @endif value="2027">2027</option>
                                <option @if($account->useridyear=='2028') selected @endif value="2028">2028</option>
                                <option @if($account->useridyear=='2029') selected @endif value="2029">2029</option>
                                <option @if($account->useridyear=='2030') selected @endif value="2030">2030</option>
                                <option @if($account->useridyear=='2031') selected @endif value="2031">2031</option>
                                <option @if($account->useridyear=='2032') selected @endif value="2032">2032</option>
                                <option @if($account->useridyear=='2033') selected @endif value="2033">2033</option>
                                <option @if($account->useridyear=='2034') selected @endif value="2034">2034</option>
                                <option @if($account->useridyear=='2035') selected @endif value="2035">2035</option>
                                <option @if($account->useridyear=='2036') selected @endif value="2036">2036</option>
                                <option @if($account->useridyear=='2037') selected @endif value="2037">2037</option>
                                <option @if($account->useridyear=='2038') selected @endif value="2038">2038</option>
                                <option @if($account->useridyear=='2039') selected @endif value="2039">2039</option>
                                <option @if($account->useridyear=='2040') selected @endif value="2040">2040</option>
                                <option @if($account->useridyear=='2041') selected @endif value="2041">2041</option>
                                <option @if($account->useridyear=='2042') selected @endif value="2042">2042</option>
                                <option @if($account->useridyear=='2043') selected @endif value="2043">2043</option>
                                <option @if($account->useridyear=='2044') selected @endif value="2044">2044</option>
                                <option @if($account->useridyear=='2045') selected @endif value="2045">2045</option>
                                <option @if($account->useridyear=='2046') selected @endif value="2046">2046</option>
                                <option @if($account->useridyear=='2047') selected @endif value="2047">2047</option>
                                <option @if($account->useridyear=='2048') selected @endif value="2048">2048</option>
                                <option @if($account->useridyear=='2049') selected @endif value="2049">2049</option>
                                <option @if($account->useridyear=='2050') selected @endif value="2050">2050</option>
                                <option @if($account->useridyear=='2051') selected @endif value="2051">2051</option>
                                <option @if($account->useridyear=='2052') selected @endif value="2052">2052</option>
                                <option @if($account->useridyear=='2053') selected @endif value="2053">2053</option>
                                <option @if($account->useridyear=='2054') selected @endif value="2054">2054</option>
                                <option @if($account->useridyear=='2055') selected @endif value="2055">2055</option>
                                <option @if($account->useridyear=='2056') selected @endif value="2056">2056</option>
                                <option @if($account->useridyear=='2057') selected @endif value="2057">2057</option>
                                <option @if($account->useridyear=='2058') selected @endif value="2058">2058</option>
                                <option @if($account->useridyear=='2059') selected @endif value="2059">2059</option>
                                <option @if($account->useridyear=='2060') selected @endif value="2060">2060</option>
                            </select>
                        </div>
                        <div class="form-group mb-3 title_div editAccount user_account_id_div">
                            ...
                            <select class="control-label" name="useridmonth" id="useridmonth">
                                <option @if($account->useridmonth=='1') selected @endif value="1">1</option>
                                <option @if($account->useridmonth=='2') selected @endif value="2">2</option>
                                <option @if($account->useridmonth=='3') selected @endif value="3">3</option>
                                <option @if($account->useridmonth=='4') selected @endif value="4">4</option>
                                <option @if($account->useridmonth=='5') selected @endif value="5">5</option>
                                <option @if($account->useridmonth=='6') selected @endif value="6">6</option>
                                <option @if($account->useridmonth=='7') selected @endif value="7">7</option>
                                <option @if($account->useridmonth=='8') selected @endif value="8">8</option>
                                <option @if($account->useridmonth=='9') selected @endif value="9">9</option>
                                <option @if($account->useridmonth=='10') selected @endif value="10">10</option>
                                <option @if($account->useridmonth=='11') selected @endif value="11">11</option>
                                <option @if($account->useridmonth=='12') selected @endif value="12">12</option>
                            </select>
                        </div>
                        <div class="form-group mb-3 title_div editAccount user_account_id_div">
                            ...
                            <select class="control-label" name="useriddate" id="useriddate">
                                <option @if($account->useriddate=='1') selected @endif value="1">1</option>
                                <option @if($account->useriddate=='2') selected @endif value="2">2</option>
                                <option @if($account->useriddate=='3') selected @endif value="3">3</option>
                                <option @if($account->useriddate=='4') selected @endif value="4">4</option>
                                <option @if($account->useriddate=='5') selected @endif value="5">5</option>
                                <option @if($account->useriddate=='6') selected @endif value="6">6</option>
                                <option @if($account->useriddate=='7') selected @endif value="7">7</option>
                                <option @if($account->useriddate=='8') selected @endif value="8">8</option>
                                <option @if($account->useriddate=='9') selected @endif value="9">9</option>
                                <option @if($account->useriddate=='10') selected @endif value="10">10</option>
                                <option @if($account->useriddate=='11') selected @endif value="11">11</option>
                                <option @if($account->useriddate=='12') selected @endif value="12">12</option>
                                <option @if($account->useriddate=='13') selected @endif value="13">13</option>
                                <option @if($account->useriddate=='14') selected @endif value="14">14</option>
                                <option @if($account->useriddate=='15') selected @endif value="15">15</option>
                                <option @if($account->useriddate=='16') selected @endif value="16">16</option>
                                <option @if($account->useriddate=='17') selected @endif value="17">17</option>
                                <option @if($account->useriddate=='18') selected @endif value="18">18</option>
                                <option @if($account->useriddate=='19') selected @endif value="19">19</option>
                                <option @if($account->useriddate=='20') selected @endif value="20">20</option>
                                <option @if($account->useriddate=='21') selected @endif value="21">21</option>
                                <option @if($account->useriddate=='22') selected @endif value="22">22</option>
                                <option @if($account->useriddate=='23') selected @endif value="23">23</option>
                                <option @if($account->useriddate=='24') selected @endif value="24">24</option>
                                <option @if($account->useriddate=='25') selected @endif value="25">25</option>
                                <option @if($account->useriddate=='26') selected @endif value="26">26</option>
                                <option @if($account->useriddate=='27') selected @endif value="27">27</option>
                                <option @if($account->useriddate=='28') selected @endif value="28">28</option>
                                <option @if($account->useriddate=='29') selected @endif value="29">29</option>
                                <option @if($account->useriddate=='30') selected @endif value="30">30</option>
                                <option @if($account->useriddate=='31') selected @endif value="31">31</option>
                            </select>
                        </div>

                        <div class="form-group mb-3 title_div editAccount user_account_id_div last">
                            <label for="role" class="control-label required" aria-required="true">Role</label>
                            <select name="role" class="form-control" required>
                                <option value="">Select Role</option>
                                @foreach($roles as $rol)
                                    <option @if($account->role==$rol->id) selected @endif value="{{$rol->id}}">{{$rol->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <h3 class="bank_info">Bank Information</h3>
                        <div class="bank_info_main_div">
                            <div class="form-group mb-3 bankDetail">
                                <label for="bankName" class="control-label" aria-required="true">Bank Name</label>
                                <input class="form-control" placeholder="Bank Name" name="bankName" type="text" @if($BankDetail!=null) value="{{$BankDetail->bankName}}" @endif id="bankName" />
                            </div>

                            <div class="form-group mb-3 bankDetail">
                                <label for="routingName" class="control-label" aria-required="true">Routing</label>
                                <input class="form-control" placeholder="Routing" name="routingName" type="text" @if($BankDetail!=null) value="{{$BankDetail->routingName}}" @endif id="routingName" />
                            </div>

                            <div class="form-group mb-3 bankDetail">
                                <label for="accountName" class="control-label" aria-required="true">Account</label>
                                <input class="form-control" placeholder="Account" name="accountName" type="text" @if($BankDetail!=null) value="{{$BankDetail->accountName}}" @endif id="accountName" />
                            </div>

                            <div class="form-group mb-3 bankDetail last">
                                <label for="beneficiaryName" class="control-label" aria-required="true">Beneficiary</label>
                                <input class="form-control" placeholder="Beneficiary" name="beneficiaryName" type="text" @if($BankDetail!=null) value="{{$BankDetail->beneficiaryName}}" @endif id="beneficiaryName" />
                            </div>
                        </div>
