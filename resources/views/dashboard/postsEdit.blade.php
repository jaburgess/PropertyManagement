...
<div class="propertyCreate dashboardProperties">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">News & Events Update</li>
    </ol>
    ...
    <form method="POST" action="{{ route('dashboardPostsCreateEditPost') }}" class="post formvalidationappeared property"  id="botble-real-estate-forms-property-form"  enctype="multipart/form-data">
        @csrf
                ...
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group mb-3 title_div">
                            ...
                            <input class="form-control" placeholder="Title" name="name" type="text" id="name" value="{{$post->title}}" required />
                        </div>
                                ...
                                <div class="step">
                                    <div class="avatar-upload">
                                        <div class="avatar-edit">
                                            <input type="hidden" name="image_old" value="{{$post->image}}" id="propertyAddImageOld">
                                        ...
                                        <div class="avatar-preview">
                                            @if($post->image!='')
                                                <div id="propertyAddImagePreview" style="background-image: url({{ URL::to('uploaded/posts/'.$post->image) }});">
                                                </div>
                                            @else
                        ...
                        <div class="form-group mb-3 propertydescription">
                            ...
                            <textarea name="description" id="createProperty" placeholder="Property Description">{{$post->description}}</textarea>
                        </div>
                ...
                <div class="widget meta-boxes form-actions form-actions-default action-horizontal">
                    ...
                    <div class="widget-body">
                        <div class="btn-set">
                            ...
                            <button type="button" id="publish_this_property" class="btn btn-info"><i class="fa fa-save"></i> Update</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position: relative; top: 0; left: 0;" dir="ltr">
                                        <ul>
                                            @foreach($posts_categories as $posts_category)
                                                <li>
                                                    <label class="mb-2">
                                                        <input type="checkbox" value="{{$posts_category->id}}" @if(in_array($posts_category->id,explode(',',$post->category))) checked @endif name="categories[]" />
